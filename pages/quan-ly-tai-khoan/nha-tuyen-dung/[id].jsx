...
import { PhoneFilled, ChromeFilled, CheckOutlined, CloseOutlined, TeamOutlined, CreditCardFilled, SlidersFilled, ReconciliationFilled } from "@ant-design/icons"
  ...
  return (
    <div className='info-detail-page'>
      ...
      <div className="row">
        <div className="overview-info col-9">
          <div className="banner-box position-relative">
            <Image
              ...
              src={nhaTuyenDung.banner || "https://t4.ftcdn.net/jpg/04/95/28/65/240_F_495286577_rpsT2Shmr6g81hOhGXALhxWOfx1vOQBa.jpg"}
            />
            <div className="logo-box position-absolute">
              <Image
                ...
                height={"140px"}
                className="logo-cty"
                src={nhaTuyenDung.logoCty || "https://t4.ftcdn.net/jpg/04/95/28/65/240_F_495286577_rpsT2Shmr6g81hOhGXALhxWOfx1vOQBa.jpg"}
              />
            </div>
          </div>
          <h4 className="ten-cty text-center text-uppercase fs-5">
            {nhaTuyenDung.tenCty}
          </h4>
        ...
        <div className="col-3">
          <div className="heading-in-profile text-uppercase fw-bold">
            Thông tin công ty
          </div>
          <div className="info-box">
            <InfoItem
              icon={<PhoneFilled />}
              info={nhaTuyenDung.soDienThoai}
            />
            <InfoItem
              icon={<FaLocationArrow />}
              info={nhaTuyenDung.diaChi}
            />
            <InfoItem
              icon={<ChromeFilled />}
              info={nhaTuyenDung.website || "Chưa cập nhật"}
            />
            <InfoItem
              icon={<TeamOutlined />}
              info={"Quy mô: " + (nhaTuyenDung.quiMo || "Chưa cập nhật")}
            />
            <InfoItem
              icon={<CreditCardFilled />}
              info={"MST: " + nhaTuyenDung.maSoThue}
            />
            <InfoItem
              icon={<SlidersFilled />}
          ...
          <div className="heading-in-profile text-uppercase fw-bold justify-content-between d-flex align-items-center" style={{ paddingTop: "12px" }}>
            Trạng thái
            <Switch
              size="small"
          ...
          <div className="heading-in-profile text-uppercase fw-bold justify-content-between d-flex align-items-center" style={{ paddingTop: "12px" }}>
            Đăng ký
            <div>
              {converTime(nhaTuyenDung.created_at)}
            </div>
          </div>
        </div>
      </div>
